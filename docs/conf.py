...
# documentation.
html_theme_options = {"index_logo": "flask-openid.png", "github_fork": "puiterwijk/flask-oidc"}
...
latex_documents = [
    (master_doc, "Flask-OIDC.tex", "Flask-OIDC Documentation", "Patrick Uiterwijk", "manual"),
]
